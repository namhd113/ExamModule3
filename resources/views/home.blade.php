                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a href="{{route('category.list')}}">Hiển thị danh mục</a></li>
                    ...
                    <li class="sub-menu">
                        <a href="javascript:;">
                            <i class="fa fa-book"></i>
                            <span>Quản lý San pham</span>
                        </a>
                        <ul class="sub">
                            <li><a href="{{route('product.create')}}">Thêm san pham</a></li>
                            <li><a href="{{route('product.list')}}">Hiển thị san pham</a></li>
